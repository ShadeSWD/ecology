...
(function () {
  ...
  /* ---------- справочник ПДК (СанПиН 1.2.3685-21, таблица 1.1 —
   * атмосферный воздух городских и сельских поселений).
   * Ноль означает «норматив не установлен» и печатается прочерком.
   * Таблица 1.1 содержит три графы ПДК — максимальную разовую,
   * среднесуточную и среднегодовую; здесь нужны первые две. ---------- */
  const CAT = {
    co:    { name: 'Оксид углерода (CO)',          mr: 5,     ss: 3,      cls: 4, col: '#155e75' },
    no2:   { name: 'Диоксид азота (NO₂)',          mr: 0.2,   ss: 0.1,    cls: 3, col: '#b3382e' },
    no:    { name: 'Оксид азота (NO)',             mr: 0.4,   ss: 0,      cls: 3, col: '#c2683f' },
    so2:   { name: 'Диоксид серы (SO₂)',           mr: 0.5,   ss: 0.05,   cls: 3, col: '#6b6b74' },
    h2s:   { name: 'Сероводород (H₂S)',            mr: 0.008, ss: 0,      cls: 2, col: '#8a8a92' },
    nh3:   { name: 'Аммиак (NH₃)',                 mr: 0.2,   ss: 0.1,    cls: 4, col: '#4a7fa0' },
    ...
    soot:  { name: 'Углерод (пигмент чёрный, сажа)', mr: 0.15, ss: 0.05,  cls: 3, col: '#16161a' },
    form:  { name: 'Формальдегид (HCHO)',          mr: 0.05,  ss: 0.01,   cls: 2, col: '#7a3fa0' },
    bap:   { name: 'Бенз(а)пирен',                 mr: 0,     ss: 1e-6,   cls: 1, col: '#5b2a86' },
    phenol:{ name: 'Фенол (гидроксибензол)',       mr: 0.01,  ss: 0.006,  cls: 2, col: '#9a4f6a' },
    o3:    { name: 'Озон (O₃)',                    mr: 0.16,  ss: 0.03,   cls: 1, col: '#2b8fa0' },
    benz:  { name: 'Бензол',                       mr: 0.3,   ss: 0.06,   cls: 2, col: '#5f7a3f' },
